...
public class SubheadingExtractor implements Runnable {
    ...
    // It check if the text is not too short or too long, does not start with
    // "copyright", does not contain "cookie", and is not just numbers or dots.
    public boolean isValidSubheading(String text) {
    ...
    public String normalizeSubheading(String text) {
        return text.
